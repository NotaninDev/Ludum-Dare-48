...
public class Option : MonoBehaviour
{
    ...
    public void Initialize(string sortingLayerName, int sortingOrder, Sprite sprite, float defaultScale, float expansionScale,
        int textSortingOrder, string text, Graphics.Font font, float fontSize, Color32 color, Vector2 margin, bool fixedSize,
        float lineSpacing = 0, TextAlignmentOptions alignment = TextAlignmentOptions.Midline, Vector2 textAreaSize = new Vector2(), bool useCollider = false)
    {
        selected = false;
    ...
    public void Initialize(string sortingLayerName, int sortingOrder, Sprite sprite, Sprite extraSprite, float defaultScale, float expansionScale,
        int textSortingOrder, string text, Graphics.Font font, float fontSize, Color32 color, Color32 extraColor, Vector2 margin, bool fixedSize,
        float lineSpacing = 0, TextAlignmentOptions alignment = TextAlignmentOptions.Midline, Vector2 textAreaSize = new Vector2(), bool useCollider = false)
    {
        selected = false;
        hasExtraSprite = true;
    ...
    public void SetSelected(bool selected)
    {
        ...
        {
            SpriteObjects[0].transform.localScale = selected ? new Vector3(defaultScale * expansionScale, defaultScale * expansionScale, 1) : new Vector3(defaultScale, defaultScale, 1);
        }
    }
}
